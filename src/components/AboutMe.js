...
const AboutMe = () => {
  return (<div id="aboutMe">
        ...
        <div class="row">
          ...
          <div class="col-md-8">
            <div id="about-right">
              ...
              <p>Now that I’m graduated, I’m really looking forward to expanding my knowledge base, putting my education to use, and striving to write efficient and elegant code. Currently, I’m learning about react hooks and incorporating that into my react app that I built called
                <a target="_blank" rel="noopener noreferrer" href="http://nyt-bookmark.herokuapp.com/"> BookMark</a>.
              </p>
            </div>
          </div>
        </div>
    ...
    <div id="about-bottom">
      <img className="about-image" src={require('../assets/images/plant.jpg')} alt="a wall of green lush leaves"/>
    </div>
  </div>)
}
